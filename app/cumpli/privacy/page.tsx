...
export const metadata = {
  title: 'Privacy Policy — Cumpli',
  description: 'Privacy Policy for Cumpli birthday reminder app',
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      ...
      <div className="border-b bg-card/30">
        <div className="container mx-auto px-4 py-16 md:py-20 max-w-4xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-2">Cumpli</p>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
        ...
        <Card className="p-6 md:p-8 mb-8">
          <p className="text-lg leading-relaxed">
            This Privacy Policy describes how Cumpli ("the App"), developed by <strong>Pau Pidelaserra</strong> ("Developer", "we", "us", "our"), handles your information. We are committed to protecting your privacy and being transparent about our data practices.
          </p>
        </Card>
        ...
        <div className="space-y-8">
          ...
          <Card className="p-6 md:p-8 bg-gradient-to-br from-primary/5 to-primary/10">
            ...
            <p className="text-foreground/90 leading-relaxed">
              Cumpli is a birthday reminder and management application. The App is designed with a <strong>privacy-first approach</strong>: all personal data is stored locally on your device and is not transmitted to our servers. We do not collect, store, or have access to your personal information.
            </p>
          </Card>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Names of contacts whose birthdays you wish to track.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Birthday dates and optional birth years.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Relationship categories (e.g., Friend, Family, Work, Partner).</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Gift ideas and personal notes.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Custom avatar images selected from your photo library.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Your own name and birthday (during onboarding).</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Contacts:</strong> The App reads contact names (given and family name), birthday dates, and contact identifiers from your device's Contacts app. This data is used solely to allow you to import birthday information into the App. Contact data is processed locally and is not sent to any external server.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Calendar:</strong> The App reads calendar event titles and dates to identify birthday-related events. This data is processed locally and is not transmitted externally.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Email addresses, phone numbers, or physical addresses.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Location data.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Device identifiers or advertising identifiers.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Browsing history or usage analytics.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Health or fitness data.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Financial or payment information (payments are handled entirely by Apple).</span></li>
                </ul>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="border rounded-lg p-4 bg-secondary/30">
                <p className="font-semibold mb-2">🖼️ Photo Library</p>
          ...
          <Card className="p-6 md:p-8">
            ...
            <ul className="space-y-2 text-foreground/90">
              <li className="flex gap-2"><span className="text-primary">•</span><span>Displaying and managing your birthday list.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Scheduling local notification reminders for upcoming birthdays.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Displaying birthday countdowns and calendar views.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Enabling the birthday memory game with your saved contacts.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Allowing you to organize contacts by relationship groups.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Storing your notification and display preferences.</span></li>
            </ul>
          ...
          <Card className="p-6 md:p-8 bg-gradient-to-br from-primary/5 to-primary/10">
            ...
            <ul className="space-y-2 text-foreground/90">
              <li className="flex gap-2"><span className="text-primary">•</span><span><strong>GIF search queries</strong> sent to Giphy when you use the GIF search feature.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Anonymous subscription data</strong> sent to RevenueCat for purchase management.</span></li>
            </ul>
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>View:</strong> You can view all stored data directly within the App.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Edit:</strong> You can modify any birthday entry, note, or preference at any time.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Delete Individual Entries:</strong> You can delete any individual birthday entry from the App.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Delete All Data:</strong> You can delete all stored data at once using the "Delete All Data" option in Settings.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span><strong>Uninstall:</strong> Uninstalling the App will permanently remove all associated data from your device.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  You can manage or revoke device permissions (Contacts, Calendar, Notifications, Photos) at any time through your device's Settings {'>'} Cumpli.
                </p>
              </div>
          ...
          <Card className="p-6 md:p-8">
            ...
            <ul className="space-y-2 text-foreground/90">
              <li className="flex gap-2"><span className="text-primary">•</span><span>Delete individual entries within the App.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Use the "Delete All Data" feature in Settings.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Uninstall the App from your device.</span></li>
            </ul>
          </Card>
          ...
          <Card className="p-6 md:p-8">
            ...
            <ul className="space-y-2 text-foreground/90">
              <li className="flex gap-2"><span className="text-primary">•</span><span>Analytics frameworks or SDKs.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Crash reporting tools.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Advertising networks or ad tracking.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>User behavior tracking.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Device fingerprinting.</span></li>
            </ul>
          ...
          <Card className="p-6 md:p-8">
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t">
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Know what personal data is collected about you.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Request deletion of your personal data.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Not be discriminated against for exercising your privacy rights.</span></li>
                </ul>
