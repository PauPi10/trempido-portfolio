...
export const metadata = {
  title: 'Terms of Use — Cumpli',
  description: 'Terms of Use for Cumpli birthday reminder app',
}
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 max-w-4xl">
        ...
        <Card className="p-6 md:p-8 mb-8">
          <p className="text-lg leading-relaxed">
            Welcome to Cumpli ("the App"), a birthday reminder and management application developed by <strong>Pau Pidelaserra</strong> ("Developer", "we", "us", "our"). By downloading, installing, or using the App, you agree to be bound by these Terms of Use ("Terms"). If you do not agree with these Terms, please do not use the App.
          </p>
        </Card>
        ...
        <div className="space-y-8">
          ...
          <Card className="p-6 md:p-8">
            ...
            <p className="text-foreground/90 mb-4">Cumpli is a mobile application for iOS that allows users to:</p>
            <ul className="space-y-2 text-foreground/90 ml-4">
              <li className="flex gap-2"><span className="text-primary">•</span><span>Add and manage birthday dates of friends, family, and other contacts.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Import birthday information from the device's Contacts and Calendar apps.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Set customizable reminder notifications for upcoming birthdays.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Add gift ideas and personalized notes for each contact.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Search and share birthday-themed GIFs.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>Play a memory game to help memorize birthdays.</span></li>
              <li className="flex gap-2"><span className="text-primary">•</span><span>View a calendar with upcoming birthday events.</span></li>
            </ul>
          </Card>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>All purchases are processed through the Apple App Store and are subject to Apple's terms and conditions.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Subscription payments are charged to your Apple ID account upon confirmation of purchase.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Auto-renewable subscriptions will automatically renew unless cancelled at least 24 hours before the end of the current billing period.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Your account will be charged for renewal within 24 hours prior to the end of the current period at the subscription rate.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>The Annual Plan includes a 3-day free trial. If you do not cancel before the trial period ends, your subscription will automatically begin and you will be charged.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Free trials are available once per Apple ID.</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>You may cancel your subscription at any time through your Apple ID account settings.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Cancellation takes effect at the end of the current billing period. No refunds will be issued for partial billing periods.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>For refund requests, please contact Apple Support directly.</span></li>
                </ul>
              </div>
          ...
          <Card className="p-6 md:p-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Copy, modify, distribute, sell, or lease any part of the App.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Reverse-engineer, decompile, or disassemble the App.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Use the App for any unlawful purpose.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Attempt to extract the source code of the App.</span></li>
                </ul>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 md:p-8">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  Your privacy is important to us. Please review our <Link href="/cumpli/privacy" className="text-primary hover:underline">Privacy Policy</Link>, which describes how we handle your data. The Privacy Policy is incorporated into and forms part of these Terms.
                </p>
              </div>
              ...
              <div className="pt-6 border-t">
                ...
                <ul className="space-y-2 text-foreground/90">
                  <li className="flex gap-2"><span className="text-primary">•</span><span>The App will be available at all times or function without interruption.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>Notifications will be delivered at the exact scheduled times.</span></li>
                  <li className="flex gap-2"><span className="text-primary">•</span><span>The App will be free of errors or bugs.</span></li>
                </ul>
              </div>
            </div>
          </Card>
